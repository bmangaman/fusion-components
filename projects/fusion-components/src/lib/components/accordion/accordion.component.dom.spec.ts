...
describe('AccordionComponent', () => {
  ...
  describe('when the panel title is clicked', () => {
    it('should expand the panel if it is closed', async () => {
      ...
      const titleButton: HTMLButtonElement = page.accordion.getTitleOfPanelAtIndex(0);
    ...
    it('should only expand or collapse the panel that had its title was clicked', async () => {
      ...
      const titleButton0: HTMLButtonElement = page.accordion.getTitleOfPanelAtIndex(0);
      const titleButton1: HTMLButtonElement = page.accordion.getTitleOfPanelAtIndex(1);
    ...
    it('should close all other panels if onePanelLimit is true', async () => {
      ...
      const titleButton0: HTMLButtonElement = page.accordion.getTitleOfPanelAtIndex(0);
      const titleButton1: HTMLButtonElement = page.accordion.getTitleOfPanelAtIndex(1);
      const titleButton2: HTMLButtonElement = page.accordion.getTitleOfPanelAtIndex(2);
      expect(titleButton0).toBeTruthy();
      expect(titleButton1).toBeTruthy();
