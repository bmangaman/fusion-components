...
export class TableFilterBytesComponent extends TableFilterComponent {
  TableFilter = TableFilterBytesComponent;
  ...
  @Input() translations: TableFilterBytesTranslations;
   ...
   */
  generateComparatorLabel(comparator: TableFilterBytesInputComparator): string | Observable<string> {
